module.exports = [
"[project]/.next-internal/server/app/api/monitoring/errors/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/monitoring/errors/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const shouldLog = errorLog.severity === 'critical' || errorLog.severity === 'error' || ("TURBOPACK compile-time value", "development") === 'development' && errorLog.severity === 'warning';
        if (shouldLog) {
            ...
            if (errorLog.severity === 'critical') {
                console.error('[Error Details]', {
                    ...
                    breadcrumbs: errorLog.breadcrumbs.slice(-5)
                });
            }
        }
...
async function GET(request) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(errors, {
            status: 200
        });
    } catch (error) {
        console.error('[Error Logging API] Error:', error);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__daacd090._.js.map