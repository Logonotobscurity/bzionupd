...
"[project]/src/components/category-grid.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const CategoryGrid = ({ categories, isLoading = false, columns = 4, gap = 'gap-8' })=>{
    const gridColsClass = {
        2: 'grid-cols-2 md:grid-cols-2 lg:grid-cols-2',
        3: 'grid-cols-2 md:grid-cols-3 lg:grid-cols-3',
        4: 'grid-cols-2 md:grid-cols-4 lg:grid-cols-4'
...
//# sourceMappingURL=src_caa55eec._.js.map