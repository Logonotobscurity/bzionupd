...
;
;
const products = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$all$2d$products$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["products"].map((p)=>({
        ...p,
        imageUrl: p.images[0]
    }));
const all = async ()=>{
...
const findByBrand = async (brandSlug)=>{
    const brand = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$repositories$2f$static$2f$brandRepository$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findBySlug"](brandSlug);
    if (!brand) {
        return [];
    }
...
const findByCategory = async (categorySlug)=>{
    const category = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$repositories$2f$static$2f$categoryRepository$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findBySlug"](categorySlug);
    if (!category) {
        return [];
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__51632c34._.js.map