...
const findBySku = async (sku)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$all$2d$products$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["products"].find((p)=>p.sku === sku) || null;
};
const findBySlug = async (slug)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$all$2d$products$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["products"].find((p)=>p.slug === slug) || null;
};
const findByBrand = async (brandSlug)=>{
    const brand = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$brand$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["brands"].find((b)=>b.slug === brandSlug);
    if (!brand) {
        return [];
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$all$2d$products$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["products"].filter((p)=>p.brandId === brand.id);
};
const findByCategory = async (categorySlug)=>{
    const category = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$category$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categories"].find((c)=>c.slug === categorySlug);
    if (!category) {
        return [];
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$all$2d$products$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["products"].filter((p)=>p.categorySlug === category.slug);
};
const search = async (query)=>{
    const lowerCaseQuery = query.toLowerCase();
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$all$2d$products$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["products"].filter((p)=>p.name.toLowerCase().includes(lowerCaseQuery) || p.description.toLowerCase().includes(lowerCaseQuery));
};
const getBrandStats = async ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$all$2d$products$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["products"].reduce((acc, product)=>{
...
;
class SearchService {
    static products = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$productService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProductService"].getAllProducts();
    /**
   * Search products by query string
   * Searches in name, brand, category, and description
   */ static searchProducts(query, minChars = 3) {
   ...
   */ static getSuggestions(query, limit = 5) {
        if (query.length < 2) {
            return [];
        }
        const lowerQuery = query.toLowerCase().trim();
...
function SearchBar() {
    ...
    const handleSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((query)=>{
        ...
        if (query.length >= MIN_CHARS) {
            const searchResults = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$searchService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SearchService"].searchProducts(query, MIN_CHARS);
        ...
        if (query.length >= 2) {
            const sug = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$searchService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SearchService"].getSuggestions(query);
            setSuggestions(sug);
        } else {
            setSuggestions([]);
        }
...
"[project]/src/services/brandService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$brandService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/brandService.ts [app-ssr] (ecmascript)");
...
function Header() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const categories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$categoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCategories"])();
        setProductCategories(categories.map((c)=>({
                title: c.name,
                href: `/products/category/${c.slug}`
            })));
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$brandService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBrands"])().then((brands)=>{
            setProductBrands(brands.filter((b)=>b.isFeatured).map((b)=>({
                    title: b.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4a180e2d._.js.map