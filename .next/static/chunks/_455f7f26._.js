        ...
        "ProductDetailPage.useEffect": ()=>{
            const fetchData = {
                "ProductDetailPage.useEffect.fetchData": async ()=>{
                    const productData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$productService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductPageData"])(params.slug);
                    setData(productData);
                }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductDetailPage.useEffect": ()=>{
            const productExists = items.some({
                "ProductDetailPage.useEffect.productExists": (item)=>item.id === product.id
            }["ProductDetailPage.useEffect.productExists"]);
...
_s(ProductDetailPage, "8n2ObUTUR2iQ36IVNd9fqB30ljw=", false, function() {
    return [
...
//# sourceMappingURL=_455f7f26._.js.map