...
export function BrandCard({ brand, productCount, categoryCount }: BrandCardProps) {
  return (
    <Link href={`/products/brand/${brand.slug}`}>
        <Card className="group block overflow-hidden rounded-lg border border-slate-200 hover:border-primary transition-colors duration-200 h-full flex flex-col">
            <div className="relative h-24 sm:h-28 md:h-32 bg-white group-hover:bg-primary/5 flex-grow flex items-center justify-center">
                <Image 
            ...
            <div className="p-2 sm:p-2.5 md:p-3 border-t bg-slate-50/70 group-hover:bg-primary/5">
