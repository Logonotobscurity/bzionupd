...
const brands: Brand[] = [
    ...
    { id: 'BRA_004', name: 'IRS', slug: 'irs', logo: 'https://i.ibb.co/7N68zWdJ/irs-logo.png', isFeatured: true, brand_description: 'IRS specializes in quality rice and other grains, sourced to deliver the best taste and texture for your meals.' },
    ...
    { id: 'BRA_006', name: 'Mama\'s Pride', slug: 'mamas-pride', logo: 'https://i.ibb.co/15ZSNPR/MAMA-GOLD-SEMO-Logo.png', isFeatured: false },
    { id: 'BRA_007', name: 'Mamagold', slug: 'mamagold', logo: '', isFeatured: true, brand_description: 'Mamagold provides high-quality flour and pasta products, perfect for baking and creating delicious meals.' },
